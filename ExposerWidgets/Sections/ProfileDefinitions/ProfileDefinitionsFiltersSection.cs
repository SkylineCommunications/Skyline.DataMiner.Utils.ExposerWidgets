namespace Skyline.DataMiner.Utils.ExposerWidgets.Sections.ProfileDefinitions
{
	...
	/// </summary>
	public class ProfileDefinitionsFiltersSection : SectionContainingDataMinerObjectFilters<ProfileDefinition>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ProfileDefinitionsFiltersSection"/>"/> class.
		/// </summary>
		public ProfileDefinitionsFiltersSection()
		{
		...
		public override SectionContainingDataMinerObjectFilters<ProfileDefinition> Clone()
		{
			return new ProfileDefinitionsFiltersSection();
		}
